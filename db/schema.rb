...
ActiveRecord::Schema.define(version: 2019_08_20_131628) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.index ["quiz_section_id"], name: "index_questions_on_quiz_section_id"
  end
  ...
  create_table "quiz_sections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_quiz_sections_on_user_id"
  end
  ...
  add_foreign_key "questions", "quiz_sections"
  add_foreign_key "quiz_sections", "users"
end
